...
const dummyData = Array.from({ length: 120 }, () => {
...
async function insetFaker() {
    ...
    await Promise.all(dummyData.map((i) => {
        FinancialDataService.EarningsEntry(i.userId, i.amount, i.earningType, i.createdAt);
    }));
}
insetFaker();
//# sourceMappingURL=earningsFaker.js.map